            ...
            <table id="tablaLotes" class="table table-bordered table-hover table-condensed" style="border:2px DodgerBlue;">
                ...
                <c:forEach items="${lotes}" var="lote" varStatus="contador">
                    <tr>
                        ...
                        <td><c:out value="${lote.activo}"/></td>
                        <td><input type="radio" name="idLoteElegido" value="${lote.idlote}"></td>
                    </tr>
                </c:forEach>
            </table>
            <button type="submit" class="btn btn-lg btn-primary">Ver lote</button>
        </form>
        <% DAO.cerrarSesion(); %>
    </body>
</html>
